...
<form name="getUserDetails" method="post" action="processdeletuser.php">
    ...
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <input type="submit" name="submit" value="Delete Me"style=" color:black;background-color:lightsalmon">
